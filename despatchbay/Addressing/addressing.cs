	...
	class MainClass
	{
		...
		**/
		...
		public static void Main (string[] args)
		{
			 ...
			 **/
			Console.WriteLine ("\n\n\n============================================");
			Console.WriteLine ("Calling GetDomesticAddressKeysByPost on LN1 2UE");
			AddressKeyType[] availableAddresses = null;
			LoadConfiguration ();
			try {
				availableAddresses = GetDomesticAddressKeysByPostcodeMethod ("LN12UE");
				int count = 0;
			...
			AddressDetailType addressDetail = null;
			try {
				addressDetail = GetDomesticAddressByKeyMethod ("LN12UE1007");
			 ...
			 **/
			Console.WriteLine ("\n\n\n============================================");
			Console.WriteLine ("Calling GetDomesticAddressByLookup by LN12UE and 7");
			AddressDetailType addressDetail2 = null;
			try {
				addressDetail2 = GetDomesticAddressByLookupMethod ("LN12UE", "7");
				Console.WriteLine ("Address details as follows");
